                      ...
                      <form className="form-horizontal">
                        <div className="form-group">
                          ...
                          <div className="col-sm-10">
                            <input type="text" name="sitename" value={this.state.username} className="form-control" />
                          </div>
                        </div>
                  ...
                  <div className="tab-pane active" id="general">
                    <form className="form-horizontal" action="/admin/settings" method="post">
                      <div className="form-group">
                        <label className="col-sm-2 control-label">Name</label>
                        <div className="col-sm-10">
                          <input type="text" name="sitename" value={this.state.orgname} className="form-control" />
                        </div>
                      </div>
                      <div className="line line-dashed line-lg pull-in"></div>
                      <div className="form-group">
