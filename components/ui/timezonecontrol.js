...
const timezonecontrol = ({zoneSelected, onSelect}) => (
	<select className="form-control" onChange={onSelect} name="person[time_zone_name]" id="person_time_zone_name">
		...
		<option selected="selected" value="Atlantic Time (Canada)">(GMT-04:00) Atlantic Time (Canada)</option>
